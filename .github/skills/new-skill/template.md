...
- ≤ 500 lines and under ~5,000 tokens (≈20,000 characters; tokens ≈ characters ÷ 4) — both budgets, since long lines game the line count.  Past either, factor reference files (one hop deep only); each link names what the file contains and when to read it.
