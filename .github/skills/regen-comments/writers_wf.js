...
function tightPrompt(n) {
  ...
  return voiceBlock
    ...
    + 'three sentences on what the file does. Every ledger fact lands exactly once: '
    + 'contract facts in the docstring, line facts as `#` sentences above their lines, in the same '
    + 'voice -- never notation or `->` arrows. Drop none. Weave a warning into the sentence that '
    + 'states it -- never behind scaffolding like "one thing to know" or "worth noting".\n\n'
