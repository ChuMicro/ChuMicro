...
~~Environment variable overrides: `CHUMICRO_DEVICES` and `CHUMICRO_DEVICE_CONFIG` for CI.~~ (Dropped 2026-05-03 — both env vars were anticipatory and never wired up; CI can drop a `devices.yml` at the workspace root.)
