...
4. Each library must independently meet the 94% coverage threshold.  When `-k` filtering is active or `--no-cov` is set, per-library gates are skipped since filtering naturally reduces coverage.
