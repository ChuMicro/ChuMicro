...
The repo already has compatibility-oriented task entrypoints in `ci/tasks.py`, but it does not yet have a proven native-Windows strategy for those Unix-port checks.
