...
- Repo template gets a real isolation gate.  Today the user's `feedback_no_decision_refs_in_downstream_repos.md` preference is enforced by hand-review; CHU008 makes it durable lint.
