...
**DEP-1 + DEP-3 shipped 2026-06-13 (deploy 0.32.3); DEP-4 deferred.** DEP-4 is a behaviour-preserving ~3.4k-line dedup of the critical deploy path — too risky to land at the tail of this remediation pass without real-board deploy validation on both runtimes. Tracked as its own follow-up in `next-up.md`.
