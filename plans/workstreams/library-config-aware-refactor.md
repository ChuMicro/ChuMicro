...
* **http_server — not started.**  Last Phase 2 lib.  Mirrors the WebSocketServer pattern (build listener from config keys + accept callback) plus needs to handle TLS material paths per the open question below.
