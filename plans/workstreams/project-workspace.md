...
- [ ] Layer-3 functional test: live broker round-trip — Mosquitto fixture + paho-mqtt subscriber on the host verifying N heartbeat messages arrive on the configured topic.  Needs CI-injected wifi creds + broker.
