...
- all four libraries published to PyPI at 0.1.0; subsequently iterated through 0.1.8; `BUNDLE_TOKEN` secret added; `main` is default branch; branch protection rulesets configured (enforcement deferred until repos go public)
