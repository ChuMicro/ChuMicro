...
15. Boards require ≥512 KB MCU RAM and ≥4 MB flash.  Tier 1: ESP32, ESP32-S3, ESP32-C6, RP2350.  Tier 2 (exception): ESP32-S2/C3 with PSRAM.  Unsupported: SAMD21, SAMD51, RP2040, nRF52, ESP8266, STM32F4/F7 <512 KB (Decision 0015).
...
9. `.idea/chumicro.iml` and `pyrightconfig.json` are generated by `sync-ide`.
10. CI runs host checks (required) plus advisory runtime compatibility jobs.
