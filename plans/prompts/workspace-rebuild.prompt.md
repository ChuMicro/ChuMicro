...
- `support/runtime/`, `support/test_harness/`, and `support/docs/`
...
11. CI runs host checks (required) plus required MicroPython and CircuitPython runtime compatibility jobs.
