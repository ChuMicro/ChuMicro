...
- [ ] Configure GitHub repo settings (manual — API tools don't support these):
  ...
  - ✅ `develop` branch created. ✅ `ChuMicro/ChuMicro-Bundle` repo created. ✅ `ChuMicro/ChuMicro-Bundle-Experimental` repo created. ✅ Bundle repo READMEs auto-generated by `scripts/bundle.py readme`. Still need: `BUNDLE_TOKEN` secret.
...
- [ ] Add `BUNDLE_TOKEN` secret to the source repo. Validate circup/mip install paths end-to-end (Decision 0018).
