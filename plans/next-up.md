...
- [ ] **Runner reactor — resume from handoff (`Runner.wait` + `FakePoller` + requests + mqtt + websockets `io_*` shipped; http_server `io_*` next, then heap-drift tracemalloc test and README example).**  [handoffs/2026-05-22-runner-reactor-ready-to-iterate.md](handoffs/2026-05-22-runner-reactor-ready-to-iterate.md)
