...
- [ ] **ChuMicro project-workspace workstream** — Decision 0029 records the design tradeoffs; `plans/workstreams/project-workspace.md` carries the execution plan (phases, library sequencing, acceptance criteria). Six new libraries (`chumicro-deploy`, `chumicro-repl`, `chumicro-wifi`, `chumicro-sockets` per Decision 0031, `chumicro-mqtt`, `chumicro-workspace-runtime`) plus a companion `chumicro-workspace-template` repo.
