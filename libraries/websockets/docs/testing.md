...
<!-- GENERATION INSTRUCTIONS — delete this block once the page is written.
     ...
     consumers need to fake, delete all testing-helper references:
       ...
       2. Delete `src/chumicro_websockets/testing.py`
     ...
     To fill this in, read:
       1. `src/chumicro_websockets/testing.py` — the fake classes/functions
...
`chumicro_websockets.testing` provides ...
...
```python
from chumicro_websockets.testing import Fake...
