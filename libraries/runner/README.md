...
> ```
> mpremote mip install github:ChuMicro/ChuMicro-Bundle/mpy6/chumicro_runner
> ```
...
```bash
python scripts/run.py test --libraries runner
python scripts/run.py test-libraries-functional --library runner
```
