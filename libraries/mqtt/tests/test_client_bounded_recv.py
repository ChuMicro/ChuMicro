...
Split from ``test_client_backpressure.py`` so the 16K-buffer / 8K-payload
drain test (the mqtt heap-budget floor) shares its process with as few
co-resident test objects as possible (suite-slimming convention).
"""
