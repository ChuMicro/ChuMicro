...
> ```
> mpremote mip install github:ChuMicro/ChuMicro-Bundle/mpy6/chumicro_logging
> ```
...
# MicroPython
mpremote mip install github:ChuMicro/ChuMicro-Bundle-Experimental/chumicro_logging

# CPython
pip install chumicro-logging-experimental
```
