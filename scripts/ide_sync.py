...
def _sync_pycharm_iml() -> None:
    ...
    marking the directory as a project source root (which would risk
    shadowing stdlib stubs for the CPython task-runner code).  The
    inline form keeps every PyCharm knob inside the single committed
