"""Host-side driver for the sockets_runner_connector_explicit demo.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--connect-timeout-s", type=float, default=15.0,
        help="seconds to wait for CONNECTED after CONNECTING",
    )
    parser.add_argument(
        "--completion-timeout-s", type=float, default=30.0,
        help="seconds to wait for DEMO_COMPLETE after CONNECTED",
    )
