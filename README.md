...
| **[config](libraries/config/)** | Standardized runtime-config helpers — one file per project, section-namespaced, with `<Name>Config.from_dict()` for each consumer library. |
