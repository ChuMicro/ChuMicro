...
When writing or editing any prose documentation in this repo (READMEs, guides, contributing pages), follow "Documentation tone" and its "Voice" subsection in docs/contributing/style-guide.md. The short version: written for the Adafruit-Learn beginner, positive claims over contrast frames, repo altitude on the root README, no em-dashes, plain words over clever ones, state the project's opinions straight, concrete measured claims only, no staccato over-compression, behavior over mechanics.
