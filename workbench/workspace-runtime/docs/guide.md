...
├── run.py                 # tiny shim: from chumicro_workspace_runtime.cli import main
├── pyproject.toml
├── things/
...
```python
from pathlib import Path
from chumicro_workspace_runtime import build_runtime_config
