...
order, **flatten to dotted keys**, write msgpack.  Each underlying
step is also a public function so callers that need finer control
(e.g. preview a merged config without writing) can compose them
directly.
    ...
    *,
    ...
    Args:
        ...
        project_config: Path to a per-project / per-library config
            ...
            overrides", merge yields the workspace defaults verbatim.
