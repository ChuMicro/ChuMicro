...
- **"I want a real project layout"** → [ChuMicro-Workspace-Template](https://github.com/ChuMicro/ChuMicro-Workspace-Template) plus [workspace](workspace/).  Clone it and go, with no editing of files live on the device.
...
- **"I want to watch my board's REPL after a deploy"** → [repl](repl/), or `chumicro-workspace deploy <project> --tail` from a [workspace](https://github.com/ChuMicro/ChuMicro-Workspace-Template), which pushes the code and then follows the serial output.
